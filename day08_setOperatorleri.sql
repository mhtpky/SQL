...
/* -----------------------------------------------------------------------------
  ...
  alinan sehirleri gosteren sorguyu Tekrarli verileri de gösterecek sekilde
  yaziniz.
------------------------------------------------------------------------------*/
    SELECT isim AS isim_veya_sehir,maas 
    FROM personel1 
...
/* -----------------------------------------------------------------------------
  ...
  personelin maaslarini yüksekten asaga dogru siralayarak bir tabloda gosteren
  sorguyu yaziniz.   
------------------------------------------------------------------------------*/
    SELECT isim,maas
    FROM personel1 
...
------------------------------------------------------------------------------*/ 
    ...
    -- sirketi Honda'dan farkli olanlari seç.
    SELECT isim,maas,sirket FROM personel1 WHERE maas < 5000 
    MINUS
    SELECT isim, maas ,sirket FROM personel1 WHERE sirket = 'Honda';
